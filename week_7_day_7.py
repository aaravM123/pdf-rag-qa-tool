...
Original file is located at
    https://colab.research.google.com/drive/1YA49uDqyb50UE5ynjEFVcU2hJDGIPBSd
"""
...
# 🔐 Prompt for secure GitHub token input
token = getpass("🔐 Paste your GitHub token (it will stay hidden): ")

# 📁 Repo setup for PDF RAG QA Tool
repo_url = f"https://{token}@github.com/aaravM123/pdf-rag-qa-tool.git"
...
!git add .
!git commit -m "📄 PDF RAG QA Tool – Upload, index, and query custom PDFs using GPT + FAISS"
!git branch -M main
